...
public class ListadoTestP2 {
   ...
   public static void inicializacion() {
      ...
      try{
         long errores;
         listado.cargarArchivoAsignacionSector("./datos/asignacionSECTOR1.txt");
         listado.cargarArchivoAsignacionSector("./datos/asignacionSECTOR2.txt");
         listado.cargarArchivoAsignacionRuta("./datos/asignacionRUTA1.txt");
         listado.cargarArchivoAsignacionRuta("./datos/asignacionRUTA2.txt");
         listado.cargarArchivoAsignacionRuta("./datos/asignacionRUTA3.txt");
      } catch(IOException e){
   ...
   public void testObtenerContadoresSectores() throws Exception {
      ...
      System.out.println("Sector 1: " + contadoresSectores .get(0) + "\n"
                        + "Sin sector: " + contadoresSectores .get(1) + "\n"
                        + "Sector 2: " + contadoresSectores .get(2) + "\n");
   }

   @Test
   public void testBusquedaEmpleadosSinSectorSinRuta() throws Exception {
      int res1;
      res1=listado.buscarEmpleadosSinSectorSinRuta().size();
   ...
   public void testBusquedaEmpleadosSinSector() throws Exception {
      ...
      System.out.println("RUTA 1: "+res1);

      res1=listado.buscarEmpleadosSinSector(Ruta.RUTA2).size();
      System.out.println("RUTA 2: "+res1);

      res1=listado.buscarEmpleadosSinSector(Ruta.RUTA3).size();
      System.out.println("RUTA 3: "+res1);
